...
mysql -u root
# bu sekilde root kullanicisiyla mariadb cli girmis oluyoruz.MySQL sorgulari burada calisiyor.

# Show default databases in the MariaDB Server.
SHOW DATABASES;
# mysql sorgusunun sonunda her zaman ; bulunur.
...
CREATE USER clarususer IDENTIFIED BY 'ali1234';

# Grant permissions to the user clarususer for database clarusdb.
GRANT ALL ON alidb.* TO clarususer IDENTIFIED BY 'ali1234' WITH GRANT OPTION;
