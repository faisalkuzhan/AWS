...
sudo yum update -y
# kurdugumuz amazon linux makine centos tabanli oldugu icin yum ile update ediyoruz.

2. Install the Nginx Web Server.
# makineye ngix yukleyerek web servis haline getiriyoruz.
...
# nginx calistiriyoruz
sudo systemctl status nginx
# nginx calisip calismadigini kontrol ediyoruz.
4. Check from browser with public IP/DNS

# makinenin ip adresini browsera yapistiriyoruz.
