...
```
# amacim direk localden public ec2 uzerinden private daki resource ma baglanmak. bunun icin eval "$(ssh-agent)" terminale yaziyorum. daha sonra pem file dosyamda ssh-add ./[your pem file name] komutunu calistiriyorum. ve ssh -A ec2-user@ec2-3-88-199-43 terminale yaziyorum ve publicteki ec2 ya baglaniyorum. (burada A ile public deki ec2 ma pem file mi tasimis oluyorum. eger yazmassam publicdeki ec2 ma baglanabilirim ama ondan private daki ec2 ma baglanamam). daha sonra ssh ec2-user@[Your private EC2 private IP] ile private daki ec2 ya baglanabiliyorum.
...
```
# burada public subnet uzerindeki ec2 dan private daki ec2 ya ulasabiliyoruz. bunu yapmak icin pem key dosyamizi public deki ec2 da olusturuyoruz. daha sonra ssh ec2-user@[Your private EC2 private IP] ile baglanabiliyoruz.
